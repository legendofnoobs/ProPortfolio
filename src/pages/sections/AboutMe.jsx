...
const AboutMe = () => {
	return (
		...
		// 	<div className="w-[300px] h-[300px] absolute bg-blue-800 blur-[100px] rounded-full -top-52 -right-10 z-0"></div>
		...
		// 		</div>
		// 	</div>
		// 	<div className="w-96 h-96 absolute bg-red-800/40 blur-[100px] rounded-full -bottom-52 -left-10 z-0"></div>
		// </div>

		<div className="flex flex-col gap-4 w-full h-fit">
			<motion.div className="w-full h-fit bg-white/10 border-2 border-white/20 hover:shadow-2xl hover:shadow-blue-600/30 transition ease relative overflow-hidden rounded-2xl p-2 grid" initial={{ y: "-50%", opacity: 0 }} animate={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 1 , ease:"easeInOut" }}>
				<div className="bg-zinc-900 w-full rounded-xl p-4 h-fit relative">
					...
					<p className="text-xl max-[540px]:text-lg z-10">I am a motivated and versatile individual, always eager to take on new challenges. With a passion for learning I am dedicated to delivering high-quality results. With a positive attitude and a growth mindset, I am ready to make a meaningful contribution and achieve great things.</p>

				</div>
			</motion.div>
			<div className="w-full h-fit flex justify-between gap-4 max-[1800px]:flex-col">
				<motion.div className="w-full h-fit p-2 bg-white/10 border-2 border-white/20 hover:shadow-2xl hover:shadow-red-600/30 transition ease relative overflow-hidden rounded-2xl" initial={{ x: "-50%", opacity: 0.5 }} animate={{ x: 0, opacity: 1 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 1 , ease:"easeInOut" }}>
				...
				<div className="flex flex-col items-center justify-between w-full">
					<motion.div className="w-full h-fit p-2 bg-white/10 border-2 border-white/20 hover:shadow-2xl hover:shadow-green-600/30 transition ease relative overflow-hidden rounded-2xl" initial={{ x: "50%", opacity: 0.5 }} animate={{ x: 0, opacity: 1 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 1 , ease:"easeInOut" }} >
						<div className="bg-zinc-900 w-full h-full rounded-xl p-3">
					...
					<div className="py-20">
						<h2 className="text-3xl text-center italic" style={{ textShadow: "0px 0px 10px white" }}>Lets Create Something Together!</h2>
					</div>
				</div>
			</div>
		</div>
