			...
			<div className="w-full h-fit flex justify-between gap-4 max-[1800px]:flex-col">
				...
				<div className="flex flex-col items-center justify-between w-full">
					...
					<div className="py-20 overflow-hidden">
						<motion.h2 className="text-3xl text-center italic" style={{ textShadow: "0px 0px 10px white" }} initial={{ y: 150 }} animate={{ y: 0 }} transition={{ delay: 1.5, duration: 1 }}>Lets Create Something Together!</motion.h2>
					</div>
				</div>
			</div>
		</div>
