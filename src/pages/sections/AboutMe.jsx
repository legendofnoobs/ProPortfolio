...
const AboutMe = () => {
	return (
		<div className="flex flex-col gap-4 w-full h-fit">
			<motion.div className="w-full h-fit bg-white/10 border-2 border-white/20 hover:shadow-2xl hover:shadow-blue-600/30 transition-shadow ease relative overflow-hidden rounded-2xl p-2 grid" initial={{ opacity: 0 }} animate={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.7, ease: "easeInOut", delay: 0.2 }}>
			...
			<div className="w-full h-fit flex justify-between gap-4 max-[1800px]:flex-col">
				...
				<div className="flex flex-col items-center justify-between w-full">
					<motion.div className="w-full h-fit p-2 bg-white/10 border-2 border-white/20 hover:shadow-2xl hover:shadow-green-600/30 transition-shadow ease relative overflow-hidden rounded-2xl" initial={{ opacity: 0 }} animate={{ opacity: 1 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.7, ease: "easeInOut", delay: 0.7 }} >
						<div className="bg-zinc-900 w-full h-full rounded-xl p-3">
