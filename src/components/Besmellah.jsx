...
const Besmellah = () => {
	return (
		<motion.div className="w-full p-2 bg-white/10 rounded-3xl border-2 border-white/20 max-w-5xl" initial={{ y: "10%", opacity: 0 }} animate={{ y: "0%", opacity: 1 }} transition={{ type: "tween", duration: 1, delay: 0.5 }}>
			...
			<div className="max-w-full h-[calc(100%-40px)] bg-zinc-900 rounded-b-2xl flex flex-col items-center justify-center gap-y-10 relative overflow-hidden max-[540px]:h-fit max-[540px]:py-16 py-40">
