...
const Besmellah = () => {
	return (
		<motion.div className="h-[668px] max-[1036px]:h-[500px] w-full p-2 bg-white/10 rounded-3xl border-2 border-white/20 max-[540px]:h-fit max-w-5xl" initial={{ y: "10%", opacity: 0 }} animate={{ y: "0%", opacity: 1 }} transition={{ type: "tween", duration: 1, delay: 0.5 }}>
